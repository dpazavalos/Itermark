...
class Itermark():
    """
    Extension of default iterator objects
    ...
    def __init__(self, iterable=None, ):
        ...
        self._mark = None
        """Protected bookmark index, accessed via property"""
    ...
    def _get_mark_via_iter_obj(self):
        """
        Using an iterator object, return the nth item where current _mark is n
        Used for objects that do not naturally support indexing (sets, dicts)
